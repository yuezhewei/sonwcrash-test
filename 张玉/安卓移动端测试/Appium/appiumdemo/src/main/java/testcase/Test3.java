...
//        capabilities.setCapability("app", app.getAbsolutePath());
        ...
        Thread.sleep(3000);
        driver.findElementById("cn.edu.hebtu.software.snowcarsh2:id/search_src_text").sendKeys("主流孩子");
        driver.findElementById("cn.edu.hebtu.software.snowcarsh2:id/search_go_btn").click();
